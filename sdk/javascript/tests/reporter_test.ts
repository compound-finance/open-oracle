...
test.only('signing rotation message', async () => {
  ...
  var m = ""
  var s = "0x84B35035DAA641915FFA93E352006643A46F659E4C35019C2121A5468642CD6781881D6719A69F21CA029FC69771120911863CB29DB5A145CFEB9B6BDCA8E3031b"

  const recoverable2 = utils.keccak256(m)
  const recovered2 = web3.eth.accounts.recover(recoverable, s)
