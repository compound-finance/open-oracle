...
describe('UniswapAnchoredView', () => {
  it('handles fixed_usd prices', async () => {
    const USDC = {cToken: address(1), underlying: address(2), symbol: "USDC", baseUnit: uint(1e6), priceSource: PriceSource.FIXED_USD, fixedPrice: uint(1e6), uniswapMarket: address(0), isUniswapReversed: false};
    const USDT = {cToken: address(3), underlying: address(4), symbol: "USDT", baseUnit: uint(1e6), priceSource: PriceSource.FIXED_USD, fixedPrice: uint(1e6), uniswapMarket: address(0), isUniswapReversed: false};
  ...
  it('reverts fixed_eth prices if no ETH price', async () => {
    const SAI = {cToken: address(5), underlying: address(6), symbol: "SAI", baseUnit: uint(1e18), priceSource: PriceSource.FIXED_ETH, fixedPrice: uint(5285551943761727), uniswapMarket: address(0), isUniswapReversed: false};
    const priceData = await deploy("OpenOraclePriceData", []);
  ...
  it('reverts if ETH has no uniswap market', async () => {
    const ETH = {cToken: address(5), underlying: address(6), symbol: "ETH", baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: address(0), isUniswapReversed: true};
    const SAI = {cToken: address(5), underlying: address(6), symbol: "SAI", baseUnit: uint(1e18), priceSource: PriceSource.FIXED_ETH, fixedPrice: uint(5285551943761727), uniswapMarket: address(0), isUniswapReversed: false};
    const priceData = await deploy("OpenOraclePriceData", []);
  ...
  it('reverts if non-reporter has a uniswap market', async () => {
    const ETH = {cToken: address(5), underlying: address(6), symbol: "ETH", baseUnit: uint(1e18), priceSource: PriceSource.FIXED_ETH, fixedPrice: 14, uniswapMarket: address(112), isUniswapReversed: true};
    const SAI = {cToken: address(5), underlying: address(6), symbol: "SAI", baseUnit: uint(1e18), priceSource: PriceSource.FIXED_ETH, fixedPrice: uint(5285551943761727), uniswapMarket: address(0), isUniswapReversed: false};
    const priceData = await deploy("OpenOraclePriceData", []);
  ...
  it('handles fixed_eth prices', async () => {
    ...
    const ETH = {cToken: address(5), underlying: address(6), symbol: "ETH", baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: usdc_eth_pair._address, isUniswapReversed: true};
    const SAI = {cToken: address(7), underlying: address(8), symbol: "SAI", baseUnit: uint(1e18), priceSource: PriceSource.FIXED_ETH, fixedPrice: uint(5285551943761727), uniswapMarket: address(0), isUniswapReversed: false};
    const priceData = await deploy("OpenOraclePriceData", []);
