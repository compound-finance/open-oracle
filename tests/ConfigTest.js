...
describe('Config', () => {
  ...
  it('checks gas', async () => {
    ...
    const txBase = await send(contract, 'doNothingWithSymbol', ['XYZ']);
    expect(txBase.gasUsed).toEqual(22378);
    ...
    expect(tx9.gasUsed).toEqual(23125);
    ...
    expect(tx25.gasUsed).toEqual(24789);
    ...
    expect(txZ.gasUsed).toEqual(37899);
    ...
    expect(txCT26.gasUsed).toEqual(38039);
  });
});