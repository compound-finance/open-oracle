...
async function setupUniswapAnchoredView(pairs) {
  ...
  const tokenConfigs = [
    {cToken: address(1), underlying: address(1), symbolHash: keccak256("ETH"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.ETH.pair._address, reporter: pairs.ETH.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: true},
    {cToken: address(2), underlying: address(2), symbolHash: keccak256("DAI"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.DAI.pair._address, reporter: pairs.DAI.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
    {cToken: address(3), underlying: address(3), symbolHash: keccak256("REP"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.REP.pair._address, reporter: pairs.REP.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
    {cToken: address(4), underlying: address(4), symbolHash: keccak256("BAT"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.BAT.pair._address, reporter: pairs.BAT.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
    {cToken: address(5), underlying: address(5), symbolHash: keccak256("ZRX"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.ZRX.pair._address, reporter: pairs.ZRX.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: true},
    {cToken: address(6), underlying: address(6), symbolHash: keccak256("BTC"), baseUnit: uint(1e8), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.BTC.pair._address, reporter: pairs.BTC.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
    {cToken: address(7), underlying: address(7), symbolHash: keccak256("COMP"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.COMP.pair._address, reporter: pairs.COMP.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
    {cToken: address(8), underlying: address(8), symbolHash: keccak256("KNC"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.KNC.pair._address, reporter: pairs.KNC.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: true},
    {cToken: address(9), underlying: address(9), symbolHash: keccak256("LINK"), baseUnit: uint(1e18), priceSource: PriceSource.REPORTER, fixedPrice: 0, uniswapMarket: pairs.LINK.pair._address, reporter: pairs.LINK.reporter._address, failoverPriceFeed: address(0), failoverMultiplier: uint(1e16), isUniswapReversed: false},
  ];
